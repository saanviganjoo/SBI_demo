...
export default function CorporateOnboarding({ onComplete, onCancel }: CorporateOnboardingProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            setIsSuccess(true);
            setTimeout(() => onComplete(corp), 1500);
        }, 1000);
    };

    if (isSuccess) {
        return (
            <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl shadow-sm border border-[#E5E7EB]">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mb-4">
                    <CheckCircle2 className="w-10 h-10 text-emerald-600" />
                </div>
                <h2 className="text-xl font-bold text-[#111827]">Corporate Created Successfully</h2>
                <p className="text-[#6B7280] mt-2">Redirecting to corporates list...</p>
            </div>
        );
    }
                ...
                <Section title="Corporate Information">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                        <Input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ corporateName: e.target.value })}
                        ...
                        <Input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ corporateReferenceId: e.target.value })}
                        ...
                        <Input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ corporateEmail: e.target.value })}
                ...
                <Section title="Contact Details">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                        ...
                        <Input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ contactEmail: e.target.value })}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="flex gap-2">
                                ...
                                <input 
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ phoneNumber: e.target.value })}
                        ...
                        <Input 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ designation: e.target.value })}
                ...
                <Section title="Address Details">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                        <div className="space-y-1.5">
                            ...
                            <select 
                                value={form.country}
                                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => updateForm({ country: e.target.value })}
                        ...
                        <Input 
                            label="Pincode" 
                            value={form.pincode} 
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ pincode: e.target.value })}
                        ...
                        <div className="md:col-span-1 space-y-1.5">
                            ...
                            <textarea 
                                value={form.address}
                                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateForm({ address: e.target.value })}
                        ...
                        <Input 
                            label="Block" 
                            value={form.block} 
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ block: e.target.value })}
                            placeholder="Block"
                            disabled
                            className="bg-[#F9FAFB]"
                        />
                ...
                <Section title="Legal Information">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                        <UploadInput 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ corporatePan: e.target.value })}
                        ...
                        <UploadInput 
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ gstNumber: e.target.value })}
                            placeholder="e.g. 22AAAAA0000A1Z5"
                        />
                        <UploadInput 
                            label="CIN" 
                            value={form.cin} 
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateForm({ cin: e.target.value })}
