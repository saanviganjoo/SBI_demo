      ...
      <div className="p-8 space-y-6">
        ...
        {isSubmitting ? (
          ...
          <div className="space-y-4">
            <p className="text-xs text-slate-500 text-center px-8">By clicking "Confirm & Continue", you agree to the Terms & Conditions and authorize State Bank of India to process your application.</p>
            <Button 
