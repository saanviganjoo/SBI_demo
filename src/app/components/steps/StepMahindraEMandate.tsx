            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-xs sm:text-sm font-black text-slate-700 truncate">{formData.bankName || "State Bank of India"}</p>
                </div>
                <div className="space-y-1 text-right">
                  <p className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-widest">IFSC</p>
                  <p className="text-xs sm:text-sm font-black text-slate-700 truncate">{formData.bankIfscCode || "SBIN00081"}</p>
                </div>
              </div>
            </div>
          </div>
