      ...
      <div className="flex flex-col items-center text-center space-y-8 py-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-slate-500 max-w-md mx-auto leading-relaxed px-4">
            I consent to sharing my data with <span className="font-bold text-slate-700">Mahindra Finance</span> for the purpose of verification. I understand that my data will be protected and will be securely shared.
          </p>
        </div>
