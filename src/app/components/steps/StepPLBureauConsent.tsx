...
Although State Bank of India tries to ensure that all information and recommendations provided as part of this website is correct at the time of its inclusion on the web site, State Bank of India does not guarantee the accuracy of the Information. State Bank of India makes no representations or warranties as to the completeness or accuracy of the Information.

Privacy Policy
Personal details provided to State Bank of India through this web site will only be used in accordance with our privacy policy. Please read this carefully before going on. By providing your personal details to us you are consenting to its use in accordance with our privacy policy.
...
State Bank of India may collect and store information about you when you visit our site, use our services, or view our online advertisements. 

Collected Information:
State Bank of India may collect personal information that you submit to us through the Services, which include: Name, Home address, Email address, Telephone number, Date of birth, Job position, Occupation, Company.

Use of collected Personal Information:
State Bank of India may use the personal information that is collected from you to provide requested products and services and for our internal business purposes, including responding to your requests for unique products and services.
    ...
    <StepCard maxWidth="xl">
      <div className="space-y-8">
        ...
        <div className="space-y-2 border-t border-slate-100 pt-6">
          ...
          <LegalConsent
            id="tnc"
            label="I agree to the State Bank of India Loan Terms and Conditions"
            checked={agreedTnc}
          ...
          <LegalConsent
            id="privacy"
            label="I acknowledge the State Bank of India Privacy Policy"
