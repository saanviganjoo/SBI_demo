          ...
          <div className="space-y-4 [.desktop-view_&]:space-y-8">
            ...
            <section className="space-y-3 [.desktop-view_&]:space-y-5">
              ...
              <div className="grid gap-2 sm:grid-cols-1 [.desktop-view_&]:gap-3">
                {[
                  { key: "employerConsent", text: "By entering the OTP I allow my employer to share my salary, salary account as well as my PII (Personal Identifiable Information) details with Mahindra Finance" },
