...
const MARKETPLACE_PRODUCTS = [
    { id: "sa", category: "deposits", tag: "POPULAR", title: "Savings Accounts", desc: "Regular, basic, and digital savings accounts via YONO SBI.", highlight: "Zero AMB Option", icon: PiggyBank },
    ...
    { id: "yono", category: "digital", tag: "POPULAR", title: "YONO SBI", desc: "Banking, shopping, and investment services in one app.", highlight: "All-in-one App", icon: Building2 },
    { id: "ib", category: "digital", tag: "ESSENTIAL", title: "Internet Banking", desc: "OnlineSBI for transfers, bill payments, and account services.", highlight: "24x7 Access", icon: FileText },
    { id: "mb", category: "digital", tag: "CONVENIENT", title: "Mobile Banking", desc: "Banking services through YONO Lite SBI.", highlight: "Instant Transfers", icon: Building2 },
    ...
    { id: "cmp", category: "corporate", tag: "BUSINESS", title: "Cash Management Products", desc: "YONO Business solutions for bulk and vendor payments.", highlight: "Bulk Payments", icon: FileText },
...
export default function ProductMarketplaceDashboard({
    ...
    return (
        <div className="w-full min-h-full flex flex-col">
            {showHero && (
                <div className="rounded-3xl mb-6 overflow-hidden shadow-2xl relative" style={{ background: "linear-gradient(135deg, #22509F 0%, #1A3F7A 45%, #122A55 100%)" }}>
                        ...
                        <div className="flex-1 min-w-0 text-center lg:text-left">
                            ...
                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                                <button
                                    ...
                                    className="h-12 px-6 bg-white text-[#22509F] hover:bg-white/95 font-bold text-base rounded-xl transition-all shadow-xl shadow-black/20 active:scale-[0.98]"
                                >
                                    Open Salary Account
                                </button>
                                <button
